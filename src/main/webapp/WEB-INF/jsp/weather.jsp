...
<head>
    ...
    <link rel="icon" type="image/png" href="<spring:url value="/images/weather.png"/>">
    ...
    <style type="text/css">		
		...
		.report-widget .data-holder {
			width: 130px;
		}
		
		.report-widget .primary-data-holder {
			
		}
		
		.report-widget .primary-data-holder .data {
			
		}
		
		.report-widget .primary-data-holder .data .temperature {
			font-size: medium;
			font-weight: bold;
			padding: 0pt 3pt;
			padding-left: 100px;
		...
		.report-widget .clouds {
			font-size: small;
			text-align: center;
		}
		
		.report-widget .humidity {
			color: gray;
			font-size: x-small;
			text-align: center;
		}
            ...
            <div class="col-md-6 offset-md-3">
                <form id="weather-report-form" action="#">
                    <div class="form-group">
                        <label class="font-weight-bold" for="cities">City Name(s):</label>
